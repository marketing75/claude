...
export default function Industries() {
  ...
  return (
    <section ref={ref} className="relative bg-gray-50 py-24 lg:py-32">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {industries.map((ind, i) => (
            <Link
              ...
              className="group relative flex flex-col items-center rounded-2xl border border-gray-100 bg-white p-8 text-center transition-all duration-500 hover:-translate-y-1 hover:shadow-xl hover:border-gray-200"
              style={{
                opacity: visible ? 1 : 0,
            ...
            >
              {/* Icon */}
              <div className={`mb-5 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br ${ind.gradient} text-white shadow-lg transition-transform duration-500 group-hover:scale-110`}>
                {ind.icon}
              </div>
